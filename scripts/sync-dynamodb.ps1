...
#
# OJO -Environment: dynamodb\schemas\*.json y dynamodb\items\*.json NO
...
if ($Environment -ne "dev") {
    ...
    Write-Host "Esto sobreescribe dynamodb\schemas y dynamodb\items locales (que normalmente reflejan DEV) con datos de '$Environment'." -ForegroundColor Red
...
$TablePrefix = "itl-0004-itx-$Environment-dynamo-"
$TableSuffix = "-02"
